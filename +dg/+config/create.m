...
conf.targets = struct(...
  'matching_stimuli', {{...
      struct('name', 'fix_square', 'source', 'm1_gaze', 'duration', 0.15, 'window', 'main') ...
    , struct('name', 'cued_decision', 'source', 'm1_gaze', 'duration', 0.3, 'window', 'main') ...
    , struct('name', 'choice_option0', 'source', 'm1_gaze', 'duration', 0.3, 'window', 'main') ...
    , struct('name', 'choice_option1', 'source', 'm1_gaze', 'duration', 0.3, 'window', 'main') ...
  }} ...
);
conf.sources = struct(...
