function state = delay_to_decision(program, conf)

state = ptb.State();
state.Name = 'delay_to_decision';
...
state.Duration = program.Value.trial_descriptor.DelayToDecision;
...
trial_desc = program.Value.trial_descriptor;

switch ( trial_desc.TrialType )
  case 'cued'
